...
<section id="project_list">
    ...
    <li><a href="#0" class="filter" data-filter=".category{{++$key}}">Category-{{$key}}</a></li>
    ...
    <div class="col-md-4 col-xs-6 mix full-width category{{++$index}}">
                <div class="portfolio-item">
                    <div class="blog-grid">
                    <div class="blog-thumb"><a href="{{route('project.show',$project->id)}}"><img style="height: 350px; width:350px" src="{{asset('/')}}{{$project->image}}" alt="blog thumb"></a>
                        </div>
                        <div class="blog-content">
                        <h3 class="blog-title">{{$project->title}}</h3>
                        <p>{{ substr($project->description,0,100)}}...</p><a href="{{route('project.show',$project->id)}}" class="dt-btn">More</a>
                        </div>
                    </div>
                </div>
            </div>
